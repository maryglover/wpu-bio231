...
Use separate to make a column of lat and long in the stream codes. Use `write.csv()` to save the file so you can use later. 

### Plot with Date
Choose 1 variable and 1 stream and plot with Date on the y axis
