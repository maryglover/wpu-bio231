...
In this exercise, you will explore water quality data from Raleigh zip code 27603, collected through the [NC Ambient Monitoring System](https://www.deq.nc.gov/about/divisions/water-resources/water-sciences/ecosystems-branch/ambient-monitoring-system-ams) through the NC Department of Environmental Quality. Water quality data is publicly available through the EPA [Water Quality Portal](https://www.waterqualitydata.us/). The data is collected from 2015 - 2020 and includes 18 different water quality variables, including water temperature, fecal coliform (bacteria), and dissolved oxygen for 5 different stream sites. 

In this exercise, you will need to:

1. Import the data into your workspace. The data is stored in the class data google drive folder as "NC_ambient_monitoring.csv"
